...
- I've just started a contract with [MAK SYSTEM](https://mak-system.com/) as a consultant Senior [Platform Engineer](https://platformengineering.org/blog/what-is-platform-engineering).  I'm responsible for architecting, building, and supporting a system allowing their applications to be delivered as containers to Kubernetes inside AWS in a safe and compliant manner.
